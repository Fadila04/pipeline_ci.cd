...
backend_url = st.text_input("Backend URL", "http://127.0.0.1:8001")

col1, col2 = st.columns(2)
with col1:
    feature_1 = st.slider("Largeur Pétale", value=0)
    feature_2 = st.slider("Largeur Pétale", 0, 10)
with col2:
...
st.markdown("---")
st.caption("Astuce: utilisez `http://127.0.0.1:8001` si vous lancez le backend localement avec uvicorn.")
